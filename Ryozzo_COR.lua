...
function init_gear_sets()
    ...
    sets.idle = {ammo=gear.RAbullet,
        ...
        body="Mekosuchinae Harness",hands="Iuitl Wristbands +1",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Shadow Mantle",waist="Flume Belt +1",legs="Laksamana's trews +1",feet="Iuitl Gaiters +1"}
    ...
    sets.idle.Town = {main="Surcouf's Jambiya",range="Eminent Gun",ammo=gear.RAbullet,
        ...
        body="Laksamana's Frac",hands="Iuitl Wristbands +1",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Shadow Mantle",waist="Flume Belt +1",legs="Laksamana's trews +1",feet="Iuitl Gaiters +1"}
    
    -- Defense sets
    sets.defense.PDT = {
        head="Whirlpool Mask",neck="Twilight Torque",ear1="Clearview Earring",ear2="Volley Earring",
        body="Iuitl Vest",hands="Iuitl Wristbands +1",ring1="Defending Ring",ring2=gear.DarkRing.physical,
        back="Shadow Mantle",waist="Flume Belt +1",legs="Laksamana's trews +1",feet="Iuitl Gaiters +1"}

    sets.defense.MDT = {
        head="Whirlpool Mask",neck="Twilight Torque",ear1="Clearview Earring",ear2="Volley Earring",
        body="Iuitl Vest",hands="Iuitl Wristbands +1",ring1="Defending Ring",ring2="Shadow Ring",
        back="Engulfer Cape",waist="Flume Belt +1",legs="Nahtirah Trousers",feet="Iuitl Gaiters +1"}
