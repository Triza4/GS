...
function init_gear_sets()
    ...
    sets.precast.FC['Elemental Magic'] = set_combine(sets.precast.FC, {head="Goetia petasos"})
    ...
    sets.midcast.FastRecast = {
        head="Nahtirah Hat",ear2="Loquacious Earring",
        body="Hagondes Coat +1",hands="Hagondes cuffs",ring1="Prolix Ring",
        back="Swith Cape",waist="Goading Belt",legs="Artsieq hose",feet="Hagondes Sabots"}
    ...
    sets.midcast['Enfeebling Magic'] = {main="Lehbrailg +2",sub="Mephitis Grip",ammo="Kalboron Stone",
        ...
        body="Vanir Cotehardie",hands="Hagondes Cuffs",ring1="Strendu Ring",ring2="Sangoma Ring",
        back="Refraction Cape",waist="Demonry Sash",legs="Mes'yohi Slacks",feet="Bokwus Boots"}
    ...
    sets.midcast['Elemental Magic'] = {main="Lehbrailg +2",sub="Mephitis Grip",ammo="Kalboron Stone",
        head="Buremte Hat",neck="Eddy Necklace",ear1="Hecate's Earring",ear2="Crematio earring",
        body="Hagondes Coat +1",hands="Otomi Gloves",ring1="Strendu Ring",ring2="Acumen Ring",
