...
function init_gear_sets()
	...
	-- Sets for specific actions within spell.type (chr+vit)
	sets.precast.Waltz['Healing Waltz'] = {}

    -- Sets for fast cast gear for spells
	sets.precast.FC = {ammo="Impatiens",head="Cizin helm +1",ear2="Loquacious Earring"}
	...
	sets.precast.WS = {ammo="Aqreqaq Bomblet",
        ...
        body="Phorcys Korazin",hands="Pummeler's Mufflers +1",ring1="Rajas Ring",ring2="Pyrosoul Ring",
        back="Mauler's Mantle",waist="Windbuffet Belt +1",legs="Agoge Cuisses +1",feet="Pummeler's Calligae +1"}
	...
	sets.precast.WS.MS = set_combine(sets.precast.WS, {ammo="Yetshila",back="Cavaros Mantle",feet="Hrafn Gambieras"})
	
	-- Specific weaponskill sets.
	sets.precast.WS['Upheaval'] = {ammo="Oneiros Pebble",
        head="Felistris Mask",neck="Flame Gorget",ear1="Moonshade Earring",ear2="Brutal Earring",
        body="Mes'yohi haubergeon",hands="Agoge Mufflers +1",ring1="Rajas Ring",ring2="Pyrosoul Ring",
	...
	sets.precast.WS['Upheaval'].AccHigh = set_combine(sets.precast.WS['Upheaval'].AccLow, {head="Yaoyotl Helm",ring1="Mars's Ring",
	    hands="Xaddi Gauntlets",back="Mauler's Mantle",legs="Pummeler's Cuisses +1"})
	sets.precast.WS['Upheaval'].Attack = set_combine(sets.precast.WS['Upheaval'], {})
	sets.precast.WS['Upheaval'].MS = set_combine(sets.precast.WS['Upheaval'], {ammo="Yetshila",back="Cavaros Mantle",feet="Hrafn Gambieras"})
	
	sets.precast.WS['Ukko\'s Fury'] = {ammo="Yetshila",
        head="Felistris Mask",neck="Thunder Gorget",ear1="Moonshade Earring",ear2="Brutal Earring",
        body="Phorcys Korazin",hands="Pummeler's Mufflers +1",ring1="Rajas Ring",ring2="Pyrosoul Ring",
        back="Rancorous Mantle",waist="Thunder Belt",legs="Agoge Cuisses +1",feet="Hrafn Gambieras"}
	sets.precast.WS['Ukko\'s Fury'].AccLow = set_combine(sets.precast.WS['Ukko\'s Fury'], {})
	sets.precast.WS['Ukko\'s Fury'].AccHigh = set_combine(sets.precast.WS['Ukko\'s Fury'].AccLow, {head="Yaoyotl Helm",ring1="Mars's Ring",
	    hands="Xaddi Gauntlets",back="Mauler's Mantle",legs="Pummeler's Cuisses +1"})
	...
	sets.precast.WS['King\'s Justice'].MS = set_combine(sets.precast.WS['King\'s Justice'], {ammo="Yetshila",back="Cavaros Mantle",feet="Hrafn Gambieras"})
	...
	sets.precast.WS['Metatron Torment'].MS = set_combine(sets.precast.WS['Metatron Torment'], {ammo="Yetshila",back="Cavaros Mantle",feet="Hrafn Gambieras"})
	...
	sets.precast.WS['Fell Cleave'] = set_combine(sets.precast.WS, {ammo="Ravager's Orb",
	    ...
	    body="Phorcys Korazin",hands="Agoge Mufflers +1",ring1="Rajas Ring",ring2="Pyrosoul Ring",
        back="Mauler's Mantle",waist="Dynamic Belt",legs="Agoge Cuisses +1",feet="Pummeler's Calligae +1"})
	...
	sets.precast.WS['Fell Cleave'].MS = set_combine(sets.precast.WS['Fell Cleave'], {ammo="Yetshila",back="Cavaros Mantle",feet="Hrafn Gambieras"})
	
	sets.precast.WS['Resolution'] = set_combine(sets.precast.WS, {ammo="Yetshita",
	    head="Otomi Helm",neck="Thunder Gorget",ear1="Moonshade Earring",ear2="Brutal Earring",
        body="Mes'yohi haubergeon",hands="Pummeler's Mufflers +1",ring1="Pyrosoul Ring",ring2="Spiral ring",
        back="Mauler's Mantle",waist="Thunder belt",legs="Agoge Cuisses +1",feet="Pummeler's Calligae +1"})
	sets.precast.WS['Resolution'].AccLow = set_combine(sets.precast.WS['Resolution'], {})
	sets.precast.WS['Resolution'].AccHigh = set_combine(sets.precast.WS['Resolution'].AccLow, {head="Yaoyotl Helm",ring2="Mars's Ring",
	    hands="Xaddi Gauntlets",back="Mauler's Mantle",legs="Pummeler's Cuisses +1",feet="Ejekamal Boots"})
	sets.precast.WS['Resolution'].Attack = set_combine(sets.precast.WS['Resolution'], {})
	sets.precast.WS['Resolution'].MS = set_combine(sets.precast.WS['Resolution'], {ammo="Yetshila",back="Cavaros Mantle",feet="Hrafn Gambieras"})
	...
	sets.midcast.FastRecast = {head="Cizin Helm +1", ear2="Loquacious Earring",body="Xaddi Mail",hands="Agoge Mufflers +2",
	    ring1="Prolix Ring",legs="Agoge Cuisses +1",feet="Ejekamal Boots"}
		
	-- Specific spells
	sets.midcast.Utsusemi = {head="Cizin Helm +1", ear2="Loquacious Earring",body="Xaddi Mail",hands="Agoge Mufflers +2",
	    ring1="Prolix Ring",legs="Agoge Cuisses +1",feet="Ejekamal Boots"}
	...
	sets.idle = {ammo="Yetshila",
        head="Felistris mask",neck="Twilight Torque",ear1="Trux earring",ear2="Sanare Earring",
        body="Mes'yohi haubergeon",hands="Agoge Mufflers +1",ring1="Dark Ring",ring2="Defending Ring",
        back="Shadow Mantle",waist="Flume Belt +1",legs="Xaddi cuisses",feet="Hermes' Sandals"}
	...
	sets.idle.Regen = {ammo="Angha Gem",
        head="Twilight Helm",neck="Wiglen Gorget",ear1="Tripudio Earring",ear2="Dawn Earring",
        body="Kumarbi's Akar",hands="Agoge Mufflers +1",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Shadow Mantle",waist="Lyopodium Sash",legs="Xaddi cuisses",feet="Hermes' Sandals"}
	
	sets.idle.Weak = {}
	
	-- Defense sets
	sets.defense.PDT = {
	    head="Cizin Helm +1",neck="Wiglen Gorget",body="Cizin Mail +1",hands="Agoge Mufflers +1",ring1="Defending Ring",
		ring2="Dark Ring",back="Iximulew Cape",waist="Nierenschutz",legs="Cizin breeches +1",feet="Cizin Greaves +1"}
	sets.defense.Reraise = set_combine(sets.defense.PDT, {head="Twilight Helm",body="Twilight Mail"})
	sets.defense.MDT = {
	    head="Felistris mask",neck="Twilight Torque",ear1="Snare Earring",body="Cizin Mail +1",hands="Agoge Mufflers +1",
		ring1="Defending Ring",ring2="Dark Ring",back="Engulfer Cape",waist="Nierenschutz",legs="Cizin Breeches +1",feet="Pummeler's Calligae +1"}
	...
	sets.engaged = {ammo="Yetshila",
		...
		back="Mauler's Mantle",waist="Windbuffet Belt +1",legs="Agoge Cuisses +1",feet="Pummeler's Calligae +1"}
	sets.engaged.AccLow = set_combine(sets.engaged, {head="Yaoyotl Helm",
	    ear1="Steelflash Earring",ear2="Bladeborn Earring"})
	sets.engaged.AccHigh = set_combine(sets.engaged.AccLow, {neck="Iqabi Necklace",
	    body="Mes'yohi haubergeon",ring1="Patricius Ring",ring2="Mars's Ring",waist="Dynamic Belt"})
	sets.engaged.PDT = set_combine(sets.engaged, {
	    head="Yaoyotl Helm",body="Mes'yohi haubergeon",hands="Agoge Mufflers +1",ring1="Defending Ring",
		ring2="Patricius Ring",legs="Cizin breeches +1",feet="Cizin Greaves +1"})
	...
	sets.engaged.Ragnarok = {ammo="Yetshila",
		head="Otomi Helm",neck="Asperity Necklace",ear1="Brutal Earring",ear2="Trux Earring",
		body="Xaddi Mail",hands="Xaddi Gauntlets",ring1="K'ayres Ring",ring2="Rajas Ring",
		back="Mauler's Mantle",waist="Windbuffet Belt +1",legs="Agoge Cuisses +1",feet="Hrafn Gambieras"}
	sets.engaged.Ragnarok.AccLow = set_combine(sets.engaged.Ragnarok, {head="Yaoyotl Helm",
	    ear1="Steelflash Earring",ear2="Bladeborn Earring"})
	sets.engaged.Ragnarok.AccHigh = set_combine(sets.engaged.Ragnarok.AccLow, {neck="Iqabi Necklace",
	    body="Mes'yohi haubergeon",ring1="Patricius Ring",ring2="Mars's Ring",waist="Dynamic Belt"})
	...
	sets.buff.MS = {ammo="Yetshila",neck="Portus Collar",back="Cavaros Mantle",feet="Hrafn Gambieras"}
