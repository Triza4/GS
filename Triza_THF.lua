...
function init_gear_sets()
    ...
    sets.buff['Sneak Attack'] = {ammo="Qirmiz Tathlum",
		...
		back="Atheling Mantle",waist="Cuchulain's Belt",legs="Pillager's Culottes +1",feet="Plunderer's Poulaines"}
    ...
    sets.precast.Waltz = {
        ...
        back="Iximulew Cape",waist="Cuchulain's Belt",legs="Pillager's Culottes +1",feet="Plunderer's Poulaines +1"}
    ...
    sets.precast.FC = {head="Haruspex Hat",ear2="Loquacious Earring",hands="Thaumas Gloves",ring1="Prolix Ring",legs="Homam Cosciales"}
    ...
    sets.precast.WS = {
		...
		body="Pillager's Vest",hands="Pillager's Armlets +1",ring1="Rajas Ring",ring2="Epona's Ring",
		back="Atheling Mantle",waist="Cuchulain's Belt",legs="Pillager's Culottes +1",feet="Iuitl Gaiters"}
    ...
    sets.midcast.Utsusemi = {
        head="Whirlpool Mask",neck="Iqabi Necklace",ear2="Loquacious Earring",
    ...
    sets.idle = {Ranged="Raider's Boomerang",
		head="Felistris Mask",neck="Wiglen Gorget",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
		body="Qaaxo harness",hands="Pillager's Armlets +1",ring1="Sheltered Ring",ring2="Paguroidea Ring",
		back="Shadow Mantle",waist="Flume Belt +1",legs="Pillager's Culottes +1",feet="Fajin boots"}

	sets.idle.Town = {Ranged="Raider's Boomerang",
		head="Felistris Mask",neck="Wiglen Gorget",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
		body="Qaaxo harness",hands="Pillager's Armlets +1",ring1="Sheltered Ring",ring2="Paguroidea Ring",
		back="Shadow Mantle",waist="Flume Belt +1",legs="Pillager's Culottes +1 +1",feet="Fajin boots"}

    sets.idle.Weak = {Ranged="Raider's Boomerang",
		head="Felistris Mask",neck="Wiglen Gorget",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
		body="Qaaxo harness",hands="Pillager's Armlets +1",ring1="Sheltered Ring",ring2="Paguroidea Ring",
		back="Shadow Mantle",waist="Flume Belt +1",legs="Pillager's Culottes +1 +1",feet="Fajin boots"}
    ...
    sets.defense.Evasion = {
        head="Pillager's Bonnet +1",neck="Iqabi Necklace",
        body="Qaaxo Harness",hands="Pillager's Armlets +1",ring1="Defending Ring",ring2="Beeline Ring",
        back="Canny Cape",waist="Flume Belt +1",legs="Kaabnax Trousers",feet="Iuitl Gaiters"}

    sets.defense.PDT = {ranged="Raider's Boomerang",
        ...
        back="Iximulew Cape",waist="Flume Belt +1",legs="Pillager's Culottes +1",feet="Iuitl Gaiters"}

    sets.defense.MDT = {Ranged="Raider's Boomerang",
        head="Pillager's Bonnet +1",neck="Twilight Torque",
        body="Pillager's Vest +1",hands="Pillager's Armlets +1",ring1="Defending Ring",ring2="Shadow Ring",
        back="Engulfer Cape",waist="Flume Belt +1",legs="Pillager's Culottes +1",feet="Iuitl Gaiters"}
    ...
    -- Normal melee group
    sets.engaged = {Ranged="Raider's Boomerang",
    ...
    sets.engaged.Acc = {Ranged="Raider's Boomerang",
    ...
    sets.engaged.Mod = {Ranged="Raider's Boomerang",
        head="Felistris Mask",neck="Asperity Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Skadi's Cuirie +1",hands="Pillager's Armlets +1",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Atheling Mantle",waist="Patentia Sash",legs=gear.AugQuiahuiz,feet="Plunderer's Poulaines"}

    -- Mod set for trivial mobs (Thaumas)
    sets.engaged.Mod2 = {ranged="Raider's Boomerang",
        head="Felistris Mask",neck="Asperity Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Thaumas Coat",hands="Pillager's Armlets +1",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Atheling Mantle",waist="Patentia Sash",legs="Pillager's Culottes +1",feet="Plunderer's Poulaines"}

    sets.engaged.Evasion = {ranged="Raider's Boomerang",
        head="Felistris Mask",neck="Iqabi Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
    ...
    sets.engaged.PDT = {ranged="Raider's Boomerang",
        head="Felistris Mask",neck="Twilight Torque",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Qaaxo Harness",hands="Pillager's Armlets +1",ring1="Defending Ring",ring2="Epona's Ring",
        back="Iximulew Cape",waist="Patentia Sash",legs="Iuitl Tights",feet="Qaaxo Leggings"}
    sets.engaged.Acc.PDT = {ranged="Raider's Boomerang",
