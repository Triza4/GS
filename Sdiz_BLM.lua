...
function init_gear_sets()
    ...
    sets.precast.WS['Vidohunir'] = {ammo="Dosis Tathlum",
        ...
        back="Toro Cape",waist="Thunder Belt",legs="Hagondes Pants +1",feet="Hagondes Sabots"}
    ...
    sets.midcast.FastRecast = {
        head="Nahtirah Hat",ear2="Loquacious Earring",
        body="Hagondes Coat +1",hands="Lurid Mitts",ring1="Prolix Ring",
        back="Swith Cape",waist="Goading Belt",legs="Artsieq Hose",feet="Umbani boots"}

    sets.midcast.Cure = {main="Tamaxchi",sub="Genbu's Shield",
        head="Nahtirah Hat",neck="Healing Torque",ear1="Healing Earring",ear2="Loquacious Earring",
        body="Heka's Kalasiris",hands="Bokwus Gloves",ring1="Ephedra Ring",ring2="Sirona's Ring",
        back="Pahtli Cape",waist=gear.ElementalObi,legs="Hagondes Pants +1",feet="Hagondes Sabots"}

    sets.midcast.Curaga = sets.midcast.Cure

    sets.midcast['Enhancing Magic'] = {
        neck="Colossus's Torque",ear1="Andoaa Earring",
    ...
    sets.midcast['Elemental Magic'] = {main="Lehbrailg +2",sub="Zuuxowu Grip",ammo="Witchstone",
        ...
        back="Toro Cape",waist="Searing Sash",legs="Hagondes Pants +1",feet="Umbani Boots"}

    sets.midcast['Elemental Magic'].Resistant = {main="Lehbrailg +2",sub="Mephitis Grip",ammo="Witchstone",
        head="Hagondes Hat +1",neck="Eddy Necklace",ear1="Hecate's Earring",ear2="Friomisi Earring",
        body="Hagondes Coat +1",hands="Hagondes Cuffs",ring1="Strendu Ring",ring2="Acumen Ring",
        back="Toro Cape",waist="Demonry sash",legs="Hagondes Pants +1",feet="Umbani Boots"}
    ...
    sets.resting = {main="Chatoyant Staff",ammo="Clarus Stone",
        head="Nefer Khat",neck="Grandiose Chain",
    ...
    sets.idle = {main="Bolelabunga",sub="Genbu's Shield",ammo="Impatiens",
        head="Nahtirah hat",neck="Twilight torque",ear1="Loquacious Earring",ear2="Snare Earring",
    ...
    sets.idle.PDT = {main="Earth Staff", sub="Oneiros Grip",ammo="Impatiens",
        head="Nahtirah Hat",neck="Twilight Torque",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Hagondes Coat +1",hands="Yaoyotl Gloves",ring1="Dark Ring",ring2="Dark Ring",
        back="Shadow Mantle",waist="Hierarch Belt",legs="Hagondes Pants +1",feet="Hagondes Sabots"}
