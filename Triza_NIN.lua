...
function init_gear_sets()
    ...
    sets.precast.WS['Blade: Hi'] = set_combine(sets.precast.WS,
        {head="Uk'uxkaj Cap",hands="Hachiya Tekko",ring1="Stormsoul Ring",legs="Kaabnax Trousers",feet="Scamp's Sollerets"})
    ...
    sets.midcast.NinjutsuBuff = {head="Hachiya Hatsuburi",neck="Iqabi Necklace",back="Yokaze Mantle"}
    ...
    sets.idle = {
        ...
        body="Mochizuki Chainmail +1",hands="Otronif Gloves +1",ring1="Sheltered Ring",ring2="Paguroidea Ring",
        back="Shadow Mantle",waist="Patentia Sash",legs="Hachiya Hakama +1",feet=gear.MovementFeet}

    sets.idle.Town = {main="Raimitsukane",sub="Kaitsuburi",ammo="Yetshila",
        head="Whirlpool Mask",neck="Wiglen Gorget",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Mochizuki Chainmail +1",hands="Otronif Gloves +1",ring1="Sheltered Ring",ring2="Paguroidea Ring",
    ...
    sets.idle.Weak = {
        ...
        back="Shadow Mantle",waist="Flume Belt +1",legs="Mochizuki Hakama +1",feet=gear.MovementFeet}
    ...
    sets.engaged = {ammo="Yetshila",
        ...
        back="Atheling Mantle",waist="Patentia Sash",legs="Mochizuki Hakama +1",feet="Qaaxo Leggings"}
    ...
    sets.engaged.Acc.PDT = {ammo="Yetshila",
    ...
    sets.engaged.HighHaste = {ammo="Yetshila",
        ...
        body="Mochizuki Chainmail +1",hands="Otronif Gloves +1",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Atheling Mantle",waist="Patentia Sash",legs="Mochizuki Hakama +1",feet="Qaaxo Leggings"}
    sets.engaged.Acc.HighHaste = {ammo="Yetshila",
        head="Whirlpool Mask",neck="Asperity Necklace",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
    ...
    sets.engaged.PDT.HighHaste = {ammo="Yetshila",
        ...
        body="Otronif Harness +1",hands="Otronif Gloves +1",ring1="Defending Ring",ring2="Epona's Ring",
        back="Yokaze Mantle",waist="Patentia Sash",legs="Hachiya Hakama",feet="Otronif Boots +1"}
    sets.engaged.Acc.PDT.HighHaste = {ammo="Yetshila",
        head="Whirlpool Mask",neck="Twilight Torque",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Otronif Harness +1",hands="Otronif Gloves +1",ring1="Defending Ring",ring2="Epona's Ring",
        back="Yokaze Mantle",waist="Hurch'lan Sash",legs="Hachiya Hakama",feet="Otronif Boots +1"}
    ...
    sets.engaged.Acc.EmbravaHaste = {ammo="Yetshila",
    ...
    sets.engaged.Acc.PDT.EmbravaHaste = {ammo="Yetshila",
        head="Whirlpool Mask",neck="Twilight Torque",ear1="Dudgeon Earring",ear2="Heartseeker Earring",
        body="Otronif Harness +1",hands="Otronif Gloves +1",ring1="Defending Ring",ring2="Epona's Ring",
    ...
    sets.engaged.MaxHaste = {ammo="Yetshila",
        head="Felistris Mask",neck="Rancor Collar",ear1="Brutal Earring",ear2="Trux Earring",
        body="Qaaxo Harness",hands="Otronif Gloves +1",ring1="Rajas Ring",ring2="Epona's Ring",
        back="Atheling Mantle",waist="Windbuffet Belt",legs="Manibozho Brais",feet="Qaaxo Leggings"}
    sets.engaged.Acc.MaxHaste = {ammo="Yetshila",
        head="Whirlpool Mask",neck="Asperity Necklace",ear1="Bladeborn Earring",ear2="Steelflash Earring",
    ...
    sets.engaged.PDT.MaxHaste = {ammo="Yetshila",
        ...
        body="Otronif Harness +1",hands="Otronif Gloves +1",ring1="Defending Ring",ring2="Epona's Ring",
        back="Yokaze Mantle",waist="Windbuffet Belt",legs="Manibozho Brais",feet="Otronif Boots +1"}
    sets.engaged.Acc.PDT.MaxHaste = {ammo="Yetshila",
        head="Whirlpool Mask",neck="Twilight Torque",ear1="Bladeborn Earring",ear2="Steelflash Earring",
        body="Otronif Harness +1",hands="Otronif Gloves +1",ring1="Defending Ring",ring2="Epona's Ring",
        back="Yokaze Mantle",waist="Hurch'lan Sash",legs="Manibozho Brais",feet="Otronif Boots +1"}
