...
function init_gear_sets()
    ...
    sets.precast.FC = {ammo="Impatiens",head="Nahtirah Hat",ear2="Loquac. Earring",
	    hands="Gendewitha Gages",ring1="Prolix Ring",ring2="Veneficium Ring",
    ...
    sets.midcast.DaurdablaDummy = {main="Atoyac",range=info.ExtraSongInstrument,
	    ...
	    body="Gendewitha Bilaut",hands="Aoidos' Manchettes +2",ring1="Prolix Ring",ring2="Sangoma Ring",
    ...
    sets.midcast.Cure = {main="Arka IV",sub="Curatio Grip",
	    ...
	    back="Tempered Cape",waist="Witful Belt",legs="Gendewitha Spats",feet="Rubeus boots"}
        
    sets.midcast.Curaga = sets.midcast.Cure
        
    sets.midcast.Stoneskin = {
        head="Nahtirah Hat",ear1="Lifestorm Earring",ear2="Aredan Earring",
	    body="Gendewitha Bilaut",hands="Gendewitha Gages",
    ...
    sets.idle = {main=gear.Staff.PDT, sub="Oneiros Grip",range="Oneiros harp",
	    ...
	    body="Gendewitha Bliaut +1",hands="Gendewitha Gages",ring1="Dark Ring",ring2="Dark Ring",
    ...
    sets.idle.Town = {main=gear.Staff.PDT, sub="Mephitis Grip",range="Oneiros Harp",
        ...
        body="Gendewitha Bliaut +1",hands="Gendewitha Gages",ring1="Paguroidea Ring",ring2="Sangoma Ring",
        back="Shadow Mantle",waist="Flume Belt +1",legs="Nares Trews",feet="Aoidos' Cothurnes +2"}
    ...
    sets.idle.Weak = {main=gear.Staff.PDT,sub="Mephitis Grip",range="Oneiros Harp",
        ...
        body="Gendewitha Bliaut +1",hands="Gendewitha Gages",ring1="Defending Ring",ring2="Sangoma Ring",
        back="Shadow Mantle",waist="Flume Belt +1",legs="Gendewitha Spats",feet="Gendewitha Galoshes"}
    ...
    sets.defense.MDT = {main=gear.Staff.PDT,sub="Mephitis Grip",
        ...
        back="Engulfer Cape",waist="Flume Belt +1",legs="Bihu Cannions",feet="Gendewitha Galoshes"}
