...
function init_gear_sets()
    ...
    sets.precast.FC = {ammo="Impatiens",head="Nahtirah Hat",ear2="Loquac. Earring",
	    hands="Gendewitha Gages +1",ring1="Prolix Ring",ring2="Veneficium Ring",
	    back="Swith Cape",waist="Witful Belt",legs="Orvail Pants",feet="Chelona Boots"}

    sets.precast.FC.Cure = set_combine(sets.precast.FC, {sub="Genbu's Shield",
    ...
    sets.precast.FC.BardSong = {main=gear.FastcastStaff,
	    ...
	    back="Swith Cape",waist="Witful Belt",legs="Gendewitha Spats +1",feet="Bihu Slippers"}
    ...
    sets.midcast.FastRecast = {range="Angel Lyre",
        ...
        back="Swith Cape",waist="Goading Belt",legs="Gendewitha Spats +1",feet="Gendewitha Galoshes +1"}
        
    -- Gear to enhance certain classes of songs.  No instruments added here since Gjallarhorn is being used.
	sets.midcast.Ballad = {legs="Aoidos' Rhing. +2",range="Eminent Flute"}
	sets.midcast.Lullaby = {hands="Brioso Cuffs",range="Pan's Horn"}
	sets.midcast.Madrigal = {head="Aoidos' Calot +2",range="Cantabank's Horn"}
	sets.midcast.March = {hands="Aoidos' Manchettes +2",range="Langeleik"}
	...
	sets.midcast["Sentinel's Scherzo"] = {feet="Aoidos' Cothrn. +2",range="Eminent Flute"}
    ...
    sets.midcast.SongEffect = {main="Legato Dagger",sub="Genbu's Shield",
    ...
    sets.midcast.SongDebuff = {main="Lehbrailg +2",sub="Mephitis Grip",range="Eminent Flute",
	    ...
	    body="Aoidos' Hongreline +2",hands="Bihu Cuffs",ring1="Sangoma Ring",ring2="Balrahn's Ring",
	    back="Rhapsode's Cape",waist="Demonry sash",legs="Bihu Cannions",feet="Brioso Slippers"}
    ...
    sets.midcast.ResistantSongDebuff = {main="Lehbrailg +2",sub="Mephitis Grip",range="Eminent Flute",
	    ...
	    body="Bihu Justaucorps",hands="Bihu Cuffs",ring1="Sangoma Ring",ring2="Balrahn's Ring",
	    back="Rhapsode's Cape",waist="Demonry sash",legs="Bihu Cannions",feet="Artsieq Boots"}
    ...
    sets.midcast.DaurdablaDummy = {main="Atoyac",range=info.ExtraSongInstrument,
        head="Nahtirah Hat",neck="Twilight Torque",ear1="Psystorm Earring",ear2="Lifestorm Earring",
	    body="Gendewitha Bilaut +1",hands="Aoidos' Manchettes +2",ring1="Prolix Ring",ring2="Sangoma Ring",
	    back="Swith Cape",waist="Goading Belt",legs="Gendewitha Spats +1",feet="Bokwus Boots"}

    -- Other general spells and classes.
    sets.midcast.Cure = {main="Arka IV",sub="Curatio Grip",
	    head="Gendewitha Caubeen +1",neck="Healing Torque",ear1="Lifestorm Earring",ear2="Aredan Earring",
	    body="Heka's kalasiris",hands="Gendewitha Gages +1",ring1="Ephedra Ring",ring2="Sirona's Ring",
	    back="Tempered Cape",waist="Witful Belt",legs="Gendewitha Spats +1",feet="Rubeus boots"}
        
    sets.midcast.Curaga = sets.midcast.Cure
        
    sets.midcast.Stoneskin = {
        head="Nahtirah Hat",ear1="Lifestorm Earring",ear2="Aredan Earring",
    ...
    sets.idle = {main=gear.Staff.PDT, sub="Oneiros Grip",range="Oneiros harp",
	    ...
	    back="Shadow Mantle",waist="Flume Belt +1",legs="Nares Trews",feet="Aoidos' Cothurnes +2"}

    sets.idle.PDT = {main=gear.Staff.PDT, sub="Oneiros Grip",range="Oneiros harp",
	    head="Gendewitha Caubeen +1",neck="Twilight Torque",ear1="Moonshade Earring",ear2="Loquacious Earring",
	    body="Gendewitha Bliaut +1",hands="Gendewitha Gages +1",ring1="Dark Ring",ring2="Dark Ring",
	    back="Shadow Mantle",waist="Flume Belt +1",legs="Nares Trews",feet="Aoidos' Cothurnes +2"}

    sets.idle.Town = {main=gear.Staff.PDT, sub="Mephitis Grip",range="Oneiros Harp",
        head="Gendewitha Caubeen +1",neck="Wiglen Gorget",ear1="Bloodgem Earring",ear2="Loquacious Earring",
        body="Gendewitha Bliaut +1",hands="Gendewitha Gages +1",ring1="Paguroidea Ring",ring2="Sangoma Ring",
        back="Shadow Mantle",waist="Flume Belt +1",legs="Nares Trews",feet="Aoidos' Cothurnes +2"}
    
    sets.idle.Weak = {main=gear.Staff.PDT,sub="Mephitis Grip",range="Oneiros Harp",
        head="Gendewitha Caubeen +1",neck="Twilight Torque",ear1="Bloodgem Earring",
        body="Gendewitha Bliaut +1",hands="Gendewitha Gages +1",ring1="Defending Ring",ring2="Sangoma Ring",
        back="Shadow Mantle",waist="Flume Belt +1",legs="Gendewitha Spats +1",feet="Gendewitha Galoshes +1"}
    ...
    sets.defense.MDT = {main=gear.Staff.PDT,sub="Mephitis Grip",
        ...
        body="Gendewitha Bliaut +1",hands="Gendewitha Gages",ring1="Defending Ring",ring2="Shadow Ring",
        back="Engulfer Cape",waist="Flume Belt +1",legs="Bihu Cannions",feet="Gendewitha Galoshes +1"}
    ...
    sets.engaged = {range="Angel Lyre",
        ...
        body="Bihu Justaucorps",hands="Buremte Gloves",ring1="Rajas Ring",ring2="K'ayres Ring",
        back="Atheling Mantle",waist="Goading Belt",legs="Brioso Cannions",feet="Gendewitha Galoshes +1"}
