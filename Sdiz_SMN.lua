...
function init_gear_sets()
	...
	sets.precast.JA['Elemental Siphon'] = {main="Kirin's Pole",sub="Vox Grip",
	    head="Convoker's Horn",neck="Caller's Pendant",ear1="Andoaa Earring",
	    body="Caller's Doublet +2",hands="Glyphic Bracers",ring1="Evoker's Ring",ring2="Fervor Ring",
	    back="Conveyance Cape",legs="Marduk's Shalwar +1",feet="Caller's Pigaches +2"}

	sets.precast.JA['Mana Cede'] = {hands="Caller's Bracers +2"}

	-- Pact delay reduction gear
	sets.precast.BloodPactWard = {ammo="Seraphicaller",head="Convoker's Horn",ear1="Caller's Earring",body="Glyphic Doublet",
	    hands="Glyphic Bracers",back="Samanisi Cape",legs="Glyphic Spats",Feet="Glyphic Pigaches"}
	...
	sets.precast.FC = {
	    ...
	    body="Eirene's Manteel",hands="Repartie Gloves",ring1="Prolix Ring",ring2="Veneficium Ring",
	...
	sets.precast.WS['Myrkr'] = {
	    ...
	    body="Convoker's Doublet",hands="Caller's Bracers +1",ring1="Evoker's Ring",ring2="Sangoma Ring",
	...
	sets.midcast['Elemental Magic'] = {main="Lehbrailg +2",sub="Zuuxowu grip",
	...
	sets.midcast.Pet.BloodPactWard = {main="Kirin's Pole",sub="Vox Grip",ammo="Seraphicaller",
	    ...
	    body="Caller's Doublet +2",hands="Glyphic Bracers",ring1="Evoker's Ring",ring2="Fervor Ring",
	    back="Conveyance Cape",waist="Diabolos's Rope",legs="Marduk's Shalwar +1",feet="Rubeus Boots"}

	sets.midcast.Pet.DebuffBloodPactWard = {main="Kirin's Pole",sub="Vox Grip",ammo="Seraphicaller",
	    head="Convoker's Horn",neck="Caller's Pendant",
	    body="Caller's Doublet +2",hands="Glyphic Bracers",ring1="Evoker's Ring",ring2="Fervor Ring",
	    back="Conveyance Cape",waist="Diabolos's Rope",legs="Marduk's Shalwar +1",feet="Rubeus Boots"}
	...
	sets.midcast.Pet.PhysicalBloodPactRage = {main="Soulscourge",sub="Vox Grop",ammo="Seraphicaller",
	    head="Convoker's Horn",neck="Caller's Pendant",Ear1="Esper earring",ear2="Demosticator's earring",
	    body="Convoker's Doublet",hands="Glyphic Bracers",ring1="Evoker's Ring",ring2="Fervor Ring",
	    back="Samanisi Cape",waist="Mujin Obi",legs="Ngen Seraweels",feet="Convoker's Pigaches"}

	sets.midcast.Pet.PhysicalBloodPactRage.Acc = sets.midcast.Pet.PhysicalBloodPactRage

	sets.midcast.Pet.MagicalBloodPactRage = {main="Eminent Pole",sub="Vox Grop",ammo="Seraphicaller",
	    head="Glyphic Horn",neck="Eidolon Pendant",Ear1="Esper earring",ear2="Demosticator's earring",
	    body="Convoker's Doublet",hands="Glyphic Bracers",ring1="Evoker's Ring",ring2="Fervor Ring",
	    back="Samanisi Cape",waist="Caller's Sash",legs="Caller's Spats +2",feet="Hagondes Sabots"}
	...
	sets.resting = {main=gear.Staff.HMP,ammo="Seraphicaller",
	    head="Convoker's Horn",neck="Twilight Torque",ear1="Gifted Earring",ear2="Moonshade Earring",
	...
	sets.idle.Avatar = {main="Gridarvor",sub="Oneiros Grip",ammo="Seraphicaller",
	    head="Convoker's Horn",neck="Caller's Pendant",ear1="Gifted Earring",ear2="Moonshade Earring",
	    body="Glyphic Doublet",hands="Serpentes Cuffs",ring1="Evoker's Ring",ring2="Sangoma Ring",
	    back="Samanisi Cape",waist="Fucho-no-Obi",legs="Nares Trews",feet="Convoker's Pigaches"}
	...
	sets.idle.Spirit = {main="Gridarvor",sub="Oneiros Grip",ammo="Seraphicaller",
	    ...
	    back="Samanisi Cape",waist="Fucho-no-Obi",legs="Summoner's Spats",feet="Serpentes Sabots"}
	...
	sets.idle.Avatar.Melee = {hands="Regimen Mittens",back="Samanisi Cape",waist="Meopapa Stone",legs="Convoker's Spats"}
