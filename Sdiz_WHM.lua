...
function init_gear_sets()
    ...
    sets.precast.FC = {main=gear.FastcastStaff,ammo="Incantor Stone",
		...
		body="Eirene's Manteel",hands="Gendewitha Gages +1",ring1="Prolix Ring",ring2="Veneficium Ring",
	...
	body="Heka's Kalasiris",feet="Cure clogs"})
    ...
    sets.precast.WS = {
        ...
        back="Refraction Cape",waist=gear.ElementalBelt,legs="Gendewitha Spats +1",feet="Gendewitha Galoshes +1"}
    
    sets.precast.WS['Flash Nova'] = {
        head="Nahtirah Hat",neck="Stoicheion Medal",ear1="Friomisi Earring",ear2="Hecate's Earring",
        body="Vanir Cotehardie",hands="Yaoyotl Gloves",ring1="Rajas Ring",ring2="Strendu Ring",
        back="Toro Cape",waist="Thunder Belt",legs="Gendewitha Spats +1",feet="Gendewitha Galoshes +1"}
    ...
    sets.midcast.FastRecast = {
       head="Nahtirah Hat",ear2="Loquacious Earring",
		body="Eirene's Manteel",hands="Blessed Mitts",ring1="Prolix Ring",
		back="Swith Cape",waist="Goading Belt",legs="Artsieq hose",feet="Gendewitha Galoshes +1"}
    ...
    sets.midcast.CureSolace = {main="Tamaxchi",sub="Genbu's Shield",ammo="Incantor Stone",
		...
		back="Tempered Cape",waist=gear.ElementalObi,legs="Orison Pantaloons +2",feet="Piety Duckbills"}
    ...
    sets.midcast.Cure = {main="Tamaxchi",sub="Genbu's Shield",ammo="Incantor Stone",
		...
		back="Tuilha Cape",waist=gear.ElementalObi,legs="Orison Pantaloons +2",feet="Piety Duckbills"}

    sets.midcast.Curaga = {main="Tamaxchi",sub="Genbu's Shield",ammo="Incantor Stone",
		head="Gendewitha Caubeen +1",neck="Orison Locket",ear1="Lifestorm Earring",ear2="Orison Earring",
		body="Eirene's Manteel",hands="Theophany Mitts",ring1="Prolix Ring",ring2="Sirona's Ring",
		back="Tuilha Cape",waist=gear.ElementalObi,legs="Orison Pantaloons +2",feet="Piety Duckbills"}
    ...
    sets.midcast.Cursna = {main="Beneficus",sub="Genbu's Shield",
		...
		back="Mending Cape",waist="Goading Belt",legs="Theophany Pantaloons",feet="Gendewitha Galoshes +1"}
    ...
    sets.midcast['Enhancing Magic'] = {main="Beneficus",sub="Genbu's Shield",
		head="Umuthi Hat",neck="Colossus's Torque",ear2="Andoaa Earring",
    ...
    sets.midcast.Stoneskin = {
		...
		back="Swith cape",waist="Siegel Sash",legs="Gendewitha Spats +1",feet="Gendewitha Galoshes +1"}
    ...
    sets.midcast.BarElement = {main="Beneficus",sub="Genbu's Shield",
		head="Orison Cap +2",neck="Colossus's Torque",ear2="Andoaa Earring",
		body="Orison briault +2",hands="Orison Mitts +2",
		back="Mending Cape",waist="Olympus Sash",legs="Piety Pantaloons",feet="Orison Duckbills +2"}
    ...
    sets.midcast['Divine Magic'] = {main="Bolelabunga",sub="Genbu's Shield",
		...
		back="Refraction Cape",waist=gear.ElementalObi,legs="Theophany Pantaloons",feet="Gendewitha Galoshes +1"}
    ...
    sets.idle = {main="Bolelabunga", sub="Genbu's Shield",ammo="Incantor Stone",
		...
		body="Gendewitha Bliaut +1",hands="Serpentes Cuffs",ring1="Dark Ring",ring2="Dark Ring",
    ...
    sets.idle.PDT = {main="Bolelabunga", sub="Genbu's Shield",ammo="Incantor Stone",
		head="Gendewitha Caubeen +1",neck="Wiglen Gorget",ear1="Moonshade Earring",ear2="Loquacious Earring",
    ...
    sets.defense.MDT = {main=gear.Staff.PDT,sub="Achaq Grip",
        ...
        back="Tuilha Cape",legs="Bokwus Slops",feet="Gendewitha Galoshes +1"}
    ...
    sets.engaged = {
        ...
        back="Umbra Cape",waist="Goading Belt",legs="Gendewitha Spats +1",feet="Gendewitha Galoshes +1"}
